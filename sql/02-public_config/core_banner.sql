...
CREATE TABLE core_banner (
    ...
    link_target_type    CHAR(1)         DEFAULT '1'                COMMENT '链接目标类型（1帖子 2文章）',
    link_type           CHAR(1)         DEFAULT '1'                COMMENT '链接类型（1内部ID 2外部链接）',
    link_value          VARCHAR(500)    DEFAULT NULL               COMMENT '链接值（帖子/文章ID或外部链接，帖子只能填ID）',
