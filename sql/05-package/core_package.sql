...
-- 套餐分类说明：
-- package_type = 1 时为普通会员（一级套餐）
-- package_type = 2 时为VIP会员（二级套餐）
-- package_type = 3 时为超级VIP会员（三级套餐）

-- ----------------------------
-- 初始化默认套餐数据
-- ----------------------------
INSERT INTO core_package (package_name, package_price, package_type, description, status) VALUES
('普通会员', 99.00, 1, '普通会员套餐', '0'),
('VIP会员', 199.00, 2, 'VIP会员套餐', '0'),
('超级VIP会员', 299.00, 3, '超级VIP会员套餐', '0');
