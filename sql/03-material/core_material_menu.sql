...
-- 首页Tab管理子菜单
-- ----------------------------
INSERT INTO sys_menu VALUES('40002', '首页Tab管理', '40000', '2', 'tag', 'core/tag/index', '', '', 1, 0, 'C', '0', '0', 'core:tag:list', 'tag', 'admin', sysdate(), '', null, '首页Tab管理菜单');

-- ----------------------------
-- 首页Tab管理权限按钮
-- ----------------------------
INSERT INTO sys_menu VALUES('40120', 'Tab查询', '40002', '1', '', '', '', '', 1, 0, 'F', '0', '0', 'core:tag:query', '#', 'admin', sysdate(), '', null, '');
INSERT INTO sys_menu VALUES('40121', 'Tab新增', '40002', '2', '', '', '', '', 1, 0, 'F', '0', '0', 'core:tag:add', '#', 'admin', sysdate(), '', null, '');
INSERT INTO sys_menu VALUES('40122', 'Tab修改', '40002', '3', '', '', '', '', 1, 0, 'F', '0', '0', 'core:tag:edit', '#', 'admin', sysdate(), '', null, '');
INSERT INTO sys_menu VALUES('40123', 'Tab删除', '40002', '4', '', '', '', '', 1, 0, 'F', '0', '0', 'core:tag:remove', '#', 'admin', sysdate(), '', null, '');
INSERT INTO sys_menu VALUES('40124', 'Tab导出', '40002', '5', '', '', '', '', 1, 0, 'F', '0', '0', 'core:tag:export', '#', 'admin', sysdate(), '', null, '');
INSERT INTO sys_menu VALUES('40125', 'Tab状态修改', '40002', '6', '', '', '', '', 1, 0, 'F', '0', '0', 'core:tag:changeStatus', '#', 'admin', sysdate(), '', null, '');
INSERT INTO sys_menu VALUES('40126', 'Tab置顶修改', '40002', '7', '', '', '', '', 1, 0, 'F', '0', '0', 'core:tag:changeTop', '#', 'admin', sysdate(), '', null, '');
