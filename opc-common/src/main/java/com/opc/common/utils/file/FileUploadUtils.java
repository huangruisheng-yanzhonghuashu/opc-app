...
import com.opc.common.exception.file.FileNameLengthLimitExceededException;
import com.opc.common.exception.file.FileSizeLimitExceededException;
import com.opc.common.exception.file.InvalidExtensionException;
import com.opc.common.utils.DateUtils;
import com.opc.common.utils.StringUtils;
import com.opc.common.utils.uuid.IdUtils;
import com.opc.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = SopConfig.getProfile();
    ...
    {
        int dirLastIndex = SopConfig.getProfile().length() + 1;
